...
class ParserConfig(Base):
    ...
    table_chunk_token_num: Annotated[int, Field(default=256, ge=0, le=4096)]
    table_header_repeat: Annotated[bool, Field(default=True)]
    table_context_size: Annotated[int, Field(default=0, ge=0, le=4096)]
